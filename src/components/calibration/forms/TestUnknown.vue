<template>
  <div class="q-py-xl flex flex-center">
    <q-card flat bordered class="q-pa-lg text-center" style="max-width: 500px">
      ...
      <q-btn outline color="primary" label="กลับไปหน้าหลัก" to="/tool-management" />
    </q-card>
  </div>
</template>
